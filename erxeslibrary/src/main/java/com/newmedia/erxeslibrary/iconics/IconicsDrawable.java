...
import com.newmedia.erxeslibrary.iconics.animation.IconicsAnimatedDrawable;
...
public class IconicsDrawable extends Drawable {
    /**
     * Size of {@link android.widget.Toolbar} icon in dp
     */
    @Dimension(unit = DP)
    public static final int TOOLBAR_ICON_SIZE = 24;

    /**
     * Size of {@link android.widget.Toolbar} icon padding in dp
     */
    @Dimension(unit = DP)
