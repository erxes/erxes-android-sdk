...
1. Bump `version` in `messenger-sdk/build.gradle.kts` (e.g. `0.30.2` → `0.30.2`).
...
- A published version is **immutable** — you cannot overwrite `0.30.2`, only release a new one.
